...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_backup_destinations_name'), 'backup_destinations', ['name'], unique=False)
    op.create_index(op.f('ix_backup_destinations_tenant_id'), 'backup_destinations', ['tenant_id'], unique=False)
    op.create_table('backup_sources',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('tenant_id', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    op.create_index(op.f('ix_backup_sources_name'), 'backup_sources', ['name'], unique=False)
    op.create_index(op.f('ix_backup_sources_tenant_id'), 'backup_sources', ['tenant_id'], unique=False)
    ...
    op.create_index(op.f('ix_backup_schedules_name'), 'backup_schedules', ['name'], unique=False)
    op.create_index(op.f('ix_backup_schedules_tenant_id'), 'backup_schedules', ['tenant_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_backup_destinations_tenant_id'), table_name='backup_destinations')
